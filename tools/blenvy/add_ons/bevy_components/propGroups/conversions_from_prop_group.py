...
conversion_tables = {
    ...
    "glam::Vec2": lambda value: "Vec2("+str(value[0])+ ", "+str(value[1])+")",
    "glam::DVec2": lambda value: "DVec2("+str(value[0])+ ", "+str(value[1])+")",
    "glam::UVec2": lambda value: "UVec2("+str(value[0])+ ", "+str(value[1])+")",

    "glam::Vec3": lambda value: "Vec3("+str(value[0])+ ", "+str(value[1])+ ", "+str(value[2])+")",
    "glam::Vec3A": lambda value: "Vec3A("+str(value[0])+ ", "+str(value[1])+ ", "+str(value[2])+")",
    "glam::UVec3": lambda value: "UVec3("+str(value[0])+ ", "+str(value[1])+ ", "+str(value[2])+")",

    "glam::Vec4": lambda value: "Vec4("+str(value[0])+ ", "+str(value[1])+ ", "+str(value[2])+ ", "+str(value[3])+")",
    "glam::DVec4": lambda value: "DVec4("+str(value[0])+ ", "+str(value[1])+ ", "+str(value[2])+ ", "+str(value[3])+")",
    "glam::UVec4": lambda value: "UVec4("+str(value[0])+ ", "+str(value[1])+ ", "+str(value[2])+ ", "+str(value[3])+")",

    "glam::Quat":  lambda value: "Quat("+str(value[0])+ ", "+str(value[1])+ ", "+str(value[2])+ ", "+str(value[3])+")",
